...
namespace WooW.SB.BlazorGenerator.BlazorComponents.BlazorInputs.WoMemoEdit
{
    public class WoMemoEditRazor
    {
        ...
        {
            return $@"
{_identMethodsAndProperties}@*Este código fue generado por el fichero WoMemoEditRazor.cs en el Path: WooW.SB\BlazorGenerator\BlazorComponents\BlazorInputs\WoMemoEdit\WoMemoEditRazor.cs.*@
...
{_identMethodsAndProperties}    <TemplateFragment>";
        ...
        private string BuildComponent()
        {
            ...
            return $@"
{_identMethodsAndProperties}        <WoMemoEdit Id=""{_lowShortComponent}{_item.Id}""
...
{_identMethodsAndProperties}                    SetStatus=""@SetStatus{_shortComponent}{_item.Id}""{length}
...
{_identMethodsAndProperties}</WoFormItem>";
        ...
        private WoLog _razorReady = new WoLog()
        {
            ...
            {
                Class = "WoMemoEditRazor",
                MethodOrContext = "GetMemoEditRazor"
            }
        };
