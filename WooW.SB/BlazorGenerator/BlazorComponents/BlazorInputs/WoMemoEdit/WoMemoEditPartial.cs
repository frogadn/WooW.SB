...
{
    public class WoMemoEditPartial
    {
        ...
        /// todo el codigo necesario para construir un memo edit
        /// </summary>
        private StringBuilder _memEdit = new StringBuilder();
        ...
        /// </summary>
        private string _shortComponent = "Mem";

        /// <summary>
        /// Prefijo del componente en minusculas
        /// </summary>
        private string _lowShortComponent = "mem";
        ...
        public WoMemoEditPartial(string identMethodsAndProperties)
        {
        ...
        public string GetCode(WoItem item)
        {
            ...
            _memEdit.AppendLine($@"{_identMethodsAndProperties}#region {item.BindedProperty}");

            _memEdit.AppendLine(BuildTag());

            _memEdit.AppendLine(BuildRefComponent());

            _memEdit.AppendLine(BuildSetStatus());

            _memEdit.AppendLine(BuildRefContainer());

            _memEdit.AppendLine(BuildSetStatusContainer());

            _memEdit.AppendLine(BuildRefAlert());

            _memEdit.AppendLine(BuildSetStatusAlert());

            _memEdit.AppendLine(BuildOnChangeEvent());

            _memEdit.AppendLine($@"{_identMethodsAndProperties}#endregion {item.BindedProperty}");

            _partialReady.Details =
                $@"Se creo el código parcial para el componente: {item.BindedProperty}.";
            _observer.SetLog(_partialReady);

            return _memEdit.ToString();
        }
        ...
        {
            return $@"
{_identMethodsAndProperties}// Este código fue generado por el fichero WoMemoEditPartial.cs en el Path: WooW.SB\BlazorGenerator\BlazorComponents\BlazorInputs\WoMemoEdit\WoMemoEditPartial.cs.
...
{_identMethodsAndProperties}/// </summary>
{_identMethodsAndProperties}private WoMemoEdit? _{_lowShortComponent}{_item.BindedProperty};";
        }
...
{_identMethodsAndProperties}}}";
        ...
        private WoLog _partialReady = new WoLog()
        {
            ...
            {
                Class = "WoMemoEditPartial",
                MethodOrContext = "GetMemoEditPartial"
            }
        };
