...
namespace WooW.SB.BlazorGenerator.BlazorComponents.BlazorInputs.WoMaskedEdit
{
    public class WoMaskedEditView
    {
        ...
        public WoMaskedEditView(string _identMethodsAndProperties)
        {
        ...
        public string GetCode(WoItem item)
        {
            ...
            _maskEdit.AppendLine(BuildComponent());

            _maskEdit.AppendLine(BuildContainerComponent());

            _maskEdit.AppendLine(BuildAlertComponent());
        ...
        {
            return $@"
{_identMethodsAndProperties}// Este código fue generado por el fichero WoMaskedEditView.cs en el Path: WooW.SB\BlazorGenerator\BlazorComponents\BlazorInputs\WoMaskedEdit\WoMaskedEditView.cs.
...
{_identMethodsAndProperties}public WoInputAlertView {_item.BindedProperty}Alert {{ get; set; }} = new WoInputAlertView();";
        ...
        private WoLog _partialReady = new WoLog()
        {
            ...
            {
                Class = "WoMaskedEditView",
                MethodOrContext = "GetMaskedEditView"
            }
        };
