...
{
    public class WoComboEnumEditPartial
    {
        ...
        /// todo el codigo necesario para construir un combo enum edit
        /// </summary>
        ...
        public WoComboEnumEditPartial(string identMethodsAndProperties)
        {
        ...
        public string GetCode(WoItem item)
        {
            ...
            _cmbEnumEdit.AppendLine(BuildRefComponent());

            _cmbEnumEdit.AppendLine(BuildSetStatus());

            _cmbEnumEdit.AppendLine(BuildRefContainer());

            _cmbEnumEdit.AppendLine(BuildSetStatusContainer());

            _cmbEnumEdit.AppendLine(BuildRefAlert());

            _cmbEnumEdit.AppendLine(BuildSetStatusAlert());

            _cmbEnumEdit.AppendLine(BuildOnChangeEvent());
        ...
        {
            return $@"
{_identMethodsAndProperties}// Este código fue generado por el fichero WoComboEnumEditPartial.cs en el Path: WooW.SB\BlazorGenerator\BlazorComponents\BlazorInputs\WoComboEnumEdit\WoComboEnumEditPartial.cs.
...
{_identMethodsAndProperties}/// </summary>
{_identMethodsAndProperties}private WoComboEnumEdit<{_item.BindingType}, App>? _{_lowShortComponent}{_item.BindedProperty};";
        }
...
{_identMethodsAndProperties}}}";
        ...
        private WoLog _partialReady = new WoLog()
        {
            ...
            {
                Class = "WoComboEnumEditPartial",
                MethodOrContext = "GetComboEnumEditPartial"
            }
        };
