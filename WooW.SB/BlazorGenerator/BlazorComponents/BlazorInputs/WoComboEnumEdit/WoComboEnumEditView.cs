...
{
    public class WoComboEnumEditView
    {
        ...
        public WoComboEnumEditView(string _identMethodsAndProperties)
        {
        ...
        {
            return $@"
{_identMethodsAndProperties}// Este código fue generado por el fichero WoComboEnumEditView.cs en el Path: WooW.SB\BlazorGenerator\BlazorComponents\BlazorInputs\WoComboEnumEdit\WoComboEnumEditView.cs.
...
{_identMethodsAndProperties}public WoInputAlertView {_item.BindedProperty}Alert {{ get; set; }} = new WoInputAlertView();";
        ...
        private WoLog _partialReady = new WoLog()
        {
            ...
            {
                Class = "WoComboEnumEditView",
                MethodOrContext = "GetComboEnumEditView"
            }
        };
