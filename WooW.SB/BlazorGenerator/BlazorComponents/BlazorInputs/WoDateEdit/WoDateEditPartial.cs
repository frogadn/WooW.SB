...
{
    public class WoDateEditPartial
    {
        ...
        /// todo el codigo necesario para construir un date edit
        /// </summary>
        ...
        /// </summary>
        private string _shortComponent = "Dte";

        /// <summary>
        /// Prefijo del componente en minusculas
        /// </summary>
        private string _lowShortComponent = "dte";

        #endregion Atributos

        #region Constructor de la clase

        public WoDateEditPartial(string identMethodsAndProperties)
        {
        ...
        public string GetCode(WoItem item)
        {
            ...
            _dateEdit.AppendLine(BuildRefComponent());

            _dateEdit.AppendLine(BuildSetStatus());

            _dateEdit.AppendLine(BuildRefContainer());

            _dateEdit.AppendLine(BuildSetStatusContainer());

            _dateEdit.AppendLine(BuildRefAlert());

            _dateEdit.AppendLine(BuildSetStatusAlert());

            _dateEdit.AppendLine(BuildOnChangeEvent());
        ...
        {
            return $@"
{_identMethodsAndProperties}// Este código fue generado por el fichero WoDateEditPartial.cs en el Path: WooW.SB\BlazorGenerator\BlazorComponents\BlazorInputs\WoDateEdit\WoDateEditPartial.cs.
...
{_identMethodsAndProperties}/// </summary>
{_identMethodsAndProperties}private WoDateEdit<{_item.BindingType},App>? _{_lowShortComponent}{_item.BindedProperty};";
        }
...
{_identMethodsAndProperties}}}";
        ...
        private WoLog _partialReady = new WoLog()
        {
            ...
            {
                Class = "WoDateEditPartial",
                MethodOrContext = "GetDateEditPartial"
            }
        };
