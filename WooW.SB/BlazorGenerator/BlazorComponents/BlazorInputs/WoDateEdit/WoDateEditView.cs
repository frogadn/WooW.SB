...
namespace WooW.SB.BlazorGenerator.BlazorComponents.BlazorInputs.WoDateEdit
{
    public class WoDateEditView
    {
        ...
        public WoDateEditView(string _identMethodsAndProperties)
        {
        ...
        public string GetCode(WoItem item)
        {
            ...
            _dateEdit.AppendLine(BuildContainerComponent());

            _dateEdit.AppendLine(BuildAlertComponent());
        ...
        {
            return $@"
{_identMethodsAndProperties}// Este código fue generado por el fichero WoDateEditView.cs en el Path: WooW.SB\BlazorGenerator\BlazorComponents\BlazorInputs\WoDateEdit\WoDateEditView.cs.
...
{_identMethodsAndProperties}public WoInputAlertView {_item.BindedProperty}Alert {{ get; set; }} = new WoInputAlertView();";
        ...
        private WoLog _partialReady = new WoLog()
        {
            ...
            {
                Class = "WoDateEditView",
                MethodOrContext = "GetDateEditView"
            }
        };
