...
namespace WooW.SB.BlazorGenerator.BlazorComponents.BlazorInputs.WoDateEdit
{
    public class WoDateEditRazor
    {
        ...
        {
            return $@"
{_identMethodsAndProperties}@*Este código fue generado por el fichero WoDateEditRazor.cs en el Path: WooW.SB\BlazorGenerator\BlazorComponents\BlazorInputs\WoDateEdit\WoDateEditRazor.cs.*@
...
{_identMethodsAndProperties}    <TemplateFragment>";
        ...
        private string BuildComponent()
        {
            ...
            return $@"
{_identMethodsAndProperties}        <WoDateEdit Id=""{_lowShortComponent}{_item.Id}""
...
{_identMethodsAndProperties}</WoFormItem>";
        ...
        private WoLog _razorReady = new WoLog()
        {
            ...
            {
                Class = "WoDateEditRazor",
                MethodOrContext = "GetDateEditRazor"
            }
        };
