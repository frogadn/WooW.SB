...
{
    public class WoCheckBoxEditView
    {
        ...
        /// todo el codigo necesario para construir un CheckBoxEdit
        /// </summary>
        ...
        public WoCheckBoxEditView(string _identMethodsAndProperties)
        {
        ...
        public string GetCode(WoItem item)
        {
            ...
            _checkBoxEdit.AppendLine(BuildComponent());

            _checkBoxEdit.AppendLine(BuildContainerComponent());

            _checkBoxEdit.AppendLine(BuildAlertComponent());
        ...
        {
            return $@"
{_identMethodsAndProperties}// Este código fue generado por el fichero WoCheckBoxEditView.cs en el Path: WooW.SB\BlazorGenerator\BlazorComponents\BlazorInputs\WoCheckBoxEdit\WoCheckBoxEditView.cs.
...
{_identMethodsAndProperties}public WoInputAlertView {_item.BindedProperty}Alert {{ get; set; }} = new WoInputAlertView();";
        ...
        private WoLog _partialReady = new WoLog()
        {
            ...
            {
                Class = "WoCheckBoxEditView",
                MethodOrContext = "GetCheckBoxEditView"
            }
        };
