...
namespace WooW.SB.BlazorGenerator.BlazorComponents.BlazorInputs.WoTextEdit
{
    public class WoTextEditView
    {
        ...
        public WoTextEditView(string _identMethodsAndProperties)
        {
        ...
        public string GetCode(WoItem item)
        {
            ...
            _strTextEdit.AppendLine(BuildContainerComponent());

            _strTextEdit.AppendLine(BuildAlertComponent());
        ...
        {
            return $@"
{_identMethodsAndProperties}// Este código fue generado por el fichero WoTextEditView.cs en el Path: WooW.SB\BlazorGenerator\BlazorComponents\BlazorInputs\WoTextEdit\WoTextEditView.cs.
...
{_identMethodsAndProperties}public WoInputAlertView {_item.BindedProperty}Alert {{ get; set; }} = new WoInputAlertView();";
        ...
        private WoLog _partialReady = new WoLog()
        {
            ...
            {
                Class = "WoTextEditView",
                MethodOrContext = "GetTextEditView"
            }
        };
