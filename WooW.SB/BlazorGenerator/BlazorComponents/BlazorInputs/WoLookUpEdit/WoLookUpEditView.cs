...
namespace WooW.SB.BlazorGenerator.BlazorComponents.BlazorInputs.WoLookUpEdit
{
    public class WoLookUpEditView
    {
        ...
        public WoLookUpEditView(string _identMethodsAndProperties)
        {
        ...
        public string GetCode(WoItem item)
        {
            ...
            _lookUpEdit.AppendLine(BuildContainerComponent());

            _lookUpEdit.AppendLine(BuildAlertComponent());
        ...
        {
            return $@"
{_identMethodsAndProperties}// Este código fue generado por el fichero WoLookUpEditView.cs en el Path: WooW.SB\BlazorGenerator\BlazorComponents\BlazorInputs\WoLookUpEdit\WoLookUpEditView.cs.
...
{_identMethodsAndProperties}public WoInputAlertView {_item.BindedProperty}Alert {{ get; set; }} = new WoInputAlertView();";
        ...
        private WoLog _partialReady = new WoLog()
        {
            ...
            {
                Class = "WoLookUpEditView",
                MethodOrContext = "GetLookUpEditView"
            }
        };
