...
{
    internal class WoLookUpEditScriptUser
    {
        ...
        public WoLookUpEditScriptUser(string _identMethodsAndProperties)
        {
        ...
        public string GetCode(WoItem item)
        {
            ...
            _lookUpEdit.AppendLine(BuildOnChangeUserCode());

            _lookUpEdit.AppendLine(BuildOnFocuseUserCode());

            _lookUpEdit.AppendLine(BuildOnBlurUserCode());
        ...
        {
            return $@"
{_identMethodsAndProperties}// Este código fue generado por el fichero WoLookUpEditScriptUser.cs en el Path: WooW.SB\BlazorGenerator\BlazorComponents\BlazorInputs\WoLookUpEdit\WoLookUpEditScriptUser.cs.
...
{_identMethodsAndProperties}}}";
        ...
        private WoLog _partialReady = new WoLog()
        {
            ...
            {
                Class = "WoLookUpEditScriptUser",
                MethodOrContext = "GetLookUpEditScriptUser"
            }
        };
