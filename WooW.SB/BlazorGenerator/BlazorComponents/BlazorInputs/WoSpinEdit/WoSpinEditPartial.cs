...
{
    public class WoSpinEditPartial
    {
        ...
        public WoSpinEditPartial(string identMethodsAndProperties)
        {
        ...
        public string GetCode(WoItem item)
        {
            ...
            _spinEdit.AppendLine(BuildRefComponent());

            _spinEdit.AppendLine(BuildSetStatus());

            _spinEdit.AppendLine(BuildRefContainer());

            _spinEdit.AppendLine(BuildSetStatusContainer());

            _spinEdit.AppendLine(BuildRefAlert());

            _spinEdit.AppendLine(BuildSetStatusAlert());

            _spinEdit.AppendLine(BuildOnChangeEvent());
        ...
        {
            return $@"
{_identMethodsAndProperties}// Este código fue generado por el fichero WoSpinEditPartial.cs en el Path: WooW.SB\BlazorGenerator\BlazorComponents\BlazorInputs\WoSpinEdit\WoSpinEditPartial.cs.
...
{_identMethodsAndProperties}/// </summary>
{_identMethodsAndProperties}private WoSpinEdit<{_item.BindingType}, App>? _{_lowShortComponent}{_item.BindedProperty};";
        }
...
{_identMethodsAndProperties}}}";
        ...
        private WoLog _partialReady = new WoLog()
        {
            ...
            {
                Class = "WoSpinEditPartial",
                MethodOrContext = "GetSpinEditPartial"
            }
        };
