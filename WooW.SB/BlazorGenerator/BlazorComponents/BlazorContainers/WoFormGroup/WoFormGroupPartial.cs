...
{
    public class WoFormGroupPartial
    {
        ...
        /// </summary>
        public WoFormGroupPartial(string identMethodsAndProperties)
        {
        ...
        {
            return $@"
{_identMethodsAndProperties}// Este código fue generado por el fichero WoFormGroupPartial.cs en el Path: WooW.SB\BlazorGenerator\BlazorComponents\BlazorContainers\WoFormGroup\WoFormGroupPartial.cs
...
{_identMethodsAndProperties}/// </summary>
{_identMethodsAndProperties}private WoFormGroup? _{_lowShortComponent}{_container.Id};";
        }
...
{_identMethodsAndProperties}        _modelControls.{_container.Id}.ChangeIconEvt += _{_lowShortComponent}{_container.Id}.ChangeIcon;
...
";
        ...
        private WoLog _partialReady = new WoLog()
        {
            ...
            {
                Class = "WoFormGroupPartial",
                MethodOrContext = "GetFormGroupPartial"
            }
        };
