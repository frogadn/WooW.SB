...
namespace WooW.SB.BlazorGenerator.BlazorComponents.BlazorContainers.WoFormGroup
{
    public class WoFormGroupView
    {
        ...
        /// </summary>
        public WoFormGroupView(string identMethodsAndProperties)
        {
...
{_identMethodsAndProperties}/// </summary>
{_identMethodsAndProperties}public WoFormGroupView {container.Id} {{ get; set; }} = new WoFormGroupView();
...
{_identMethodsAndProperties}#endregion {container.Id}"
        ...
        {
            return $@"
{_identMethodsAndProperties}// Este código fue generado por el fichero WoFormGroupView.cs en el Path: WooW.SB\BlazorGenerator\BlazorComponents\BlazorContainers\WoFormGroup\WoFormGroupView.cs
{_identMethodsAndProperties}// WoWSB por el generador a día 5-10-2023";
        ...
        {
            CodeLog = "000",
            Title = "Se ha generado la instancia de la view de un grupo.",
            LogType = eLogType.Information,
            FileDetails = new WoFileDetails()
            {
                Class = "WoFormGroupView",
