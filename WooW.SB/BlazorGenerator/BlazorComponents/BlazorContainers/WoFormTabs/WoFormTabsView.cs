...
namespace WooW.SB.BlazorGenerator.BlazorComponents.BlazorContainers.WoFormTabs
{
    public class WoFormTabsView
    {
        ...
        /// </summary>
        public WoFormTabsView(string identMethodsAndProperties)
        {
...
{_identMethodsAndProperties}#endregion {container.Id}"
        ...
        {
            return $@"
{_identMethodsAndProperties}// Este código fue generado por el fichero WoFormTabsView.cs en el Path: WooW.SB\BlazorGenerator\BlazorComponents\BlazorContainers\WoFormTabs\WoFormTabsView.cs.
{_identMethodsAndProperties}// WoWSB por el generador a día 5-10-2023";
        ...
        {
            CodeLog = "000",
            Title = "Se ha generado la instancia de la view de un grupo de tabs.",
            LogType = eLogType.Information,
            FileDetails = new WoFileDetails()
            {
                Class = "WoFormTabsView",
