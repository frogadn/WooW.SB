...
namespace WooW.SB.BlazorGenerator.BlazorComponents.BlazorContainers.WoFormTab
{
    public class WoFormTabPartial
    {
        ...
        /// </summary>
        public WoFormTabPartial(string identMethodsAndProperties)
        {
        ...
        {
            return $@"
{_identMethodsAndProperties}// Este código fue generado por el fichero WoFormTabPartial.cs en el Path: WooW.SB\BlazorGenerator\BlazorComponents\BlazorContainers\WoFormTab\WoFormTabPartial.cs
{_identMethodsAndProperties}// WoWSB por el generador a día 5-10-2023";
        }

        #endregion Tag

        #region Construcción del cogido
...
{_identMethodsAndProperties}/// </summary>
{_identMethodsAndProperties}private WoFormTab? _wft{_container.Id};";
        }
...
";
        ...
        #endregion Construcción del cogido
        ...
        private WoLog _partialReady = new WoLog()
        {
            ...
            {
                Class = "WoFormTabPartial",
                MethodOrContext = "GetFormTabPartial"
            }
        };
