...
// </auto-generated>
// ------------------------------------------------------------------------------
namespace WooW.SB.BlazorGenerator.BlazorTemplates.ServerTemplates.Shared
{
    using System;
    ...
    #line 1 "C:\Frog\WooW.SB\WooW.SB\BlazorGenerator\BlazorTemplates\ServerTemplates\Shared\WoTemplateWoHeaderLayoutPartialServer.tt"
    [global::System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.VisualStudio.TextTemplating", "17.0.0.0")]
    public partial class WoTemplateWoHeaderLayoutPartialServer : WoTemplateWoHeaderLayoutPartialServerBase
    {
#line hidden
        /// <summary>
...
using ");
            ...
            #line 11 "C:\Frog\WooW.SB\WooW.SB\BlazorGenerator\BlazorTemplates\ServerTemplates\Shared\WoTemplateWoHeaderLayoutPartialServer.tt"
            ...
            #line 19 "C:\Frog\WooW.SB\WooW.SB\BlazorGenerator\BlazorTemplates\ServerTemplates\Shared\WoTemplateWoHeaderLayoutPartialServer.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(Project));
            ...
            #line 24 "C:\Frog\WooW.SB\WooW.SB\BlazorGenerator\BlazorTemplates\ServerTemplates\Shared\WoTemplateWoHeaderLayoutPartialServer.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(Project));
            ...
            this.Write(".Shared\r\n{\r\n    public partial class WoHeaderLayout : AWoComponentBase\r\n    {\r\n  " +
                    ...
                    "      \r\n            if (firstRender)\r\n            {\r\n                try\r\n      " +
                    "          {\r\n                    _selectedRol = await LocalStorage.GetItemAsync<" +
                    "string>(\"Rol\");\r\n                    _roles = await LocalStorage.GetItemAsync<Li" +
                    "st<string>>(\"Roles\") ?? new List<string>();\r\n\r\n                    if (_selected" +
                    "Rol != null)\r\n                    {\r\n                        await SelectRol(_se" +
                    "lectedRol);\r\n\r\n                        _selectedMenu = await LocalStorage.GetIte" +
                    "mAsync<string>(\"Menu\");\r\n\r\n                        if (!_selectedMenu.IsNullOrEm" +
                    "pty())\r\n                        {\r\n                            await SelectMenu(" +
                    "_selectedMenu);\r\n                        }\r\n                    }\r\n             " +
                    "   }\r\n                catch (Exception ex)\r\n                {\r\n                 " +
                    ...
                    " /// <summary>\r\n        /// Rol seleccionado del cual se recuperaran los menus.\r" +
                    "\n        /// </summary>\r\n        private string? _selectedRol;\r\n\r\n        /// <s" +
                    "ummary>\r\n        /// Servicio que permite realizar peticiones de los roles.\r\n   " +
                    "     /// </summary>\r\n        private WoRequestService<WoRolePermissionReq, WoRol" +
                    "ePermissionRes>? _reqRol;\r\n\r\n        /// <summary>\r\n        /// Evento que se de" +
                    "tona al dar click en el dropdown de roles.\r\n        /// </summary>\r\n        /// " +
                    "<returns></returns>\r\n        private async Task RoleDropDownClick()\r\n        {\r\n" +
                    "            await LoadRoles();\r\n        }\r\n\r\n        /// <summary>\r\n        /// " +
                    "Carga el cliente y la lista de roles.\r\n        /// </summary>\r\n        /// <retu" +
                    "rns></returns>\r\n        private async Task LoadRoles()\r\n        {\r\n            t" +
                    "ry\r\n            {\r\n                if (_reqRol != null)\r\n                {\r\n    " +
                    "                IList<WoRolePermissionRes> result = await _reqRol.GetListRespons" +
                    "e();\r\n                    if (result != null)\r\n                    {\r\n          " +
                    "              _roles.Clear();\r\n\r\n                        foreach (WoRolePermissi" +
                    "onRes role in result)\r\n                        {\r\n                            _r" +
                    "oles.AddRange(role.RoleCol);\r\n                        }\r\n\r\n                     " +
                    ...
                    "mmary>\r\n        /// Lista de los nombres de los menus que se muestran en el sele" +
                    "ct.\r\n        /// </summary>\r\n        private List<string> _menus = new List<stri" +
                    "ng>();\r\n\r\n        /// <summary>\r\n        /// Lista de los menus, son los json co" +
                    "mpletos del menu.\r\n        /// </summary>\r\n        private List<string> _rawMenu" +
                    "sCol = new List<string>();\r\n\r\n        /// <summary>\r\n        /// Lista de los me" +
                    "nus deserializados a WoMenuProperties.\r\n        /// </summary>\r\n        private " +
                    "List<WoMenuProperties> _menusCol = new List<WoMenuProperties>();\r\n\r\n        /// " +
                    "<summary>\r\n        /// Servicio que permite la petición de los menus.\r\n        /" +
                    "// </summary>\r\n        private WoRequestService<WoMenusReq, WoMenusRes>? _reqMen" +
                    "u;\r\n\r\n        /// <summary>\r\n        /// Carga los menus.\r\n        /// </summary" +
                    ">\r\n        /// <returns></returns>\r\n        private async Task LoadMenus()\r\n    " +
                    "    {\r\n            try\r\n            {\r\n                if (_reqMenu != null)\r\n  " +
                    "              {\r\n                    IList<WoMenusRes> resultMenusCol = await _r" +
                    "eqMenu.GetListResponse();\r\n\r\n                    _menusCol.Clear();\r\n           " +
                    "         _menus.Clear();\r\n\r\n                    foreach (var item in resultMenus" +
                    "Col)\r\n                    {\r\n                        if (item.Rol == _selectedRo" +
                    "l)\r\n                        {\r\n                            string menu = item.Me" +
                    "nu ?? string.Empty;\r\n                            if (menu != string.Empty)\r\n    " +
                    "                        {\r\n                                WoMenuProperties? woC" +
                    "ontainer = JsonConvert.DeserializeObject<WoMenuProperties>(menu);\r\n             " +
                    "                   if (woContainer != null)\r\n                                {\r\n" +
                    ...
                    "e async Task SelectMenu(string newMenu)\r\n        {\r\n            _selectedMenu = " +
                    "newMenu;\r\n            WoMenuProperties? woContainer = _menusCol.Where(x => x.Id " +
                    "== newMenu).FirstOrDefault();\r\n\r\n            if (woContainer != null)\r\n         " +
                    "   {\r\n                _rawMenusCol.Clear();\r\n                _rawMenusCol.Add(Js" +
                    "onConvert.SerializeObject(woContainer));\r\n            }\r\n            else\r\n     " +
                    "       {\r\n                _rawMenusCol.Clear();\r\n                _rawMenusCol.Ad" +
                    "d(JsonConvert.SerializeObject(new WoMenuProperties()));\r\n            }\r\n\r\n      " +
                    ...
                    "     /// </summary>\r\n        /// <returns></returns>\r\n        private async Task" +
                    " LoadCultures()\r\n        {\r\n            string cultureStorage = await LocalStora" +
                    "ge.GetItemAsync<string>(\"culture\") ?? LocalizerSettings.NeutralCulture.Culture;\r" +
                    "\n            _cultures.Clear();\r\n            foreach (var culture in LocalizerSe" +
                    "ttings.SupportedCulturesWithName)\r\n            {\r\n                _cultures.Add(" +
                    "culture.Culture);\r\n            }\r\n            _selectedCulture = cultureStorage;" +
                    "\r\n        }\r\n\r\n        /// <summary>\r\n        /// Cambia la cultura seleccionada" +
                    "\r\n        /// </summary>\r\n        /// <param name=\"newCulture\"></param>\r\n       " +
                    " private async void ChangeCulture(string newCulture)\r\n        {\r\n            var" +
                    " uri = new Uri(Navigation.Uri)\r\n                        .GetComponents(UriCompon" +
                    "ents.PathAndQuery, UriFormat.Unescaped);\r\n            var cultureEscaped = Uri.E" +
                    "scapeDataString(newCulture);\r\n            var uriEscaped = Uri.EscapeDataString(" +
                    "uri);\r\n\r\n            await LocalStorage.SetItemAsStringAsync(\"culture\", newCultu" +
                    "re);\r\n\r\n            Navigation.NavigateTo(\r\n                $\"Culture/Set?cultur" +
                    "e={cultureEscaped}&redirectUri={uriEscaped}\",\r\n                forceLoad: true);" +
                    "\r\n        }\r\n\r\n        #endregion Selector de culturas\r\n\r\n        #region LogOut" +
                    "\r\n\r\n        /// <summary>\r\n        /// Evento que se detona al dar click en el b" +
        ...
        #line 371 "C:\Frog\WooW.SB\WooW.SB\BlazorGenerator\BlazorTemplates\ServerTemplates\Shared\WoTemplateWoHeaderLayoutPartialServer.tt"
...
public string Project { get; set; } = "";
    ...
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.VisualStudio.TextTemplating", "17.0.0.0")]
    public class WoTemplateWoHeaderLayoutPartialServerBase
    {
        #region Fields
